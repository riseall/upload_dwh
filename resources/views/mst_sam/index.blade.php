@extends('layouts.app', ['title' => 'Master SAM'])
@section('content')
    @include('layouts.partial.datatables', [
        'title' => 'Data Master',
        'subtitle' => 'Coverage SAM',
        'columns' => ['nik sam', 'nik rm', 'nama sam', 'pilar', 'subdiv'],
        'upload' => route('mst_sam.store'),
    ])
@endsection
