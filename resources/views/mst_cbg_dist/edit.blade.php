    ...
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="editMstCbgDistLabel">Edit Master <span
                    class="d-block text-muted pt-2 font-size-sm">Cabang Distributor</span></h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <i aria-hidden="true" class="ki ki-close"></i>
            </button>
        </div>
        <div class="modal-body">
            <form action="" method="POST" class="form" id="formMstCbgDist">
                @csrf
                @method('PUT')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <label for="kode_cbg_dist">Kode Cabang Distributor</label>
                        <input id="kode_cbg_dist" type="text" class="form-control" readonly
                            placeholder="Kode Cabang Distributor" name="kode_cbg_dist" />
                    </div>
                </div>
