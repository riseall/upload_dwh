...
class MstRMController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            MstRM::whereDate('created_at', $today)->delete();
            ...
            while (($row = fgetcsv($file, 0, ';', '"')) !== false) {
                ...
                try {
                    MstRM::create([
                        ...
                        'gm_nik' => $mappedRow['nik_gm'],
                        'nama_rm' => $mappedRow['nama_rm'],
            ...
            return redirect()->route('mst_rm.index')->with('success', 'Data CSV berhasil diupload dan disimpan!');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->route('mst_rm.index')->with('error', 'Terjadi kesalahan saat memproses file: ' . $e->getMessage());
        }
    }
}
